...
export const transcriptsMock: Transcript[] = [transcript1Mock, transcript2Mock]
...
export const transcriptsVersionMock: StudentTranscriptVersion[] = [transcriptsVersion1Mock, transcriptsVersion2Mock]
...
export const claimsMock: StudentTranscriptClaim[] = [claims1Mock, claims2Mock]
